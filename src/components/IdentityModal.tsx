      ...
      <div className="card w-full max-w-md p-6 space-y-4">
        ...
        {mode === 'view' && (
          <>
            ...
            <p className="text-sm text-white/60">
              Pas de profil public. Un compte (email + mot de passe) permet juste de retrouver tes échos ailleurs.
            </p>
        ...
        {mode === 'password' && (
          <>
            ...
            <p className="text-sm text-white/60">
              Toujours pas de profil public. Le pseudo ne s&apos;affiche que si tu choisis de te révéler à
              quelqu&apos;un.
            </p>
            <input
              value={pseudoInput}
